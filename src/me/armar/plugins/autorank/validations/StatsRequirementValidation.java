...
public class StatsRequirementValidation {
    ...
    /**
     * Checks if there are Stats required requirements and if Stats is required. When Stats
     * required requirements are found but Stats is not, it will warn and return false.
     *
