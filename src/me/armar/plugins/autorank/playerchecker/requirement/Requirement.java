...
/**
 * Whenever you want to create a new requirement, you'll have to extend this class. Every
 * requirement needs the following:
 *
 * <p>
 * - Option to check if the requirement is optional.
 * <p>
 * - Results that will be performed when the requirement is completed. These results have to be one
 * of the results registered in Autorank.
 * <p>
...
public abstract class Requirement {
    ...
    /**
     * Gets the dependency manager of Autorank that is used to connect to other plugins. <br>
    ...
    /**
     * Gets the description of the requirement Make sure this is always a translatable message.
     *
    ...
    /**
     * Get the id of this requirement. This should get assigned automatically at setOptions(). The
     * id should always be dynamic.
     *
     * @return id
     */
    public int getReqId() {
    ...
    /**
     * Does it meet the requirements? This method gets called when someone does /ar check or /ar
     * complete. It should always contain the following line:
     *
     * <p>
