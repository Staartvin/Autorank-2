...
/**
 * This class represents a multitude of files where are looked up uuids are stored.
 * </br>Every player has its own uuid, which is stored with the time it was last stored.
 * <p>
