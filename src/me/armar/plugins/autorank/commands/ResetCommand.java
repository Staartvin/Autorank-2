...
import me.armar.plugins.autorank.commands.conversations.resetcommand.ResetConversation;
...
public class ResetCommand extends AutorankCommand {
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        AutorankConversation resetConversation = AutorankConversation.fromFirstPrompt(new ResetConversation());

        resetConversation.afterConversationEnded(result -> {
            System.out.println("Conversation ended and was successful: " + result.wasSuccessful());
        });
