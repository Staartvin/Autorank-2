...
/**
 * This class keeps all incoming and outgoing under control. It sends MySQL queries and can locate
 * the database. Previously, {@link me.armar.plugins.autorank.playtimes.Playtimes} kept all MySQL,
 * but it wasn't neatly organised. MySQLWrapper class is (hopefully) fail-prove and organised.
 *
...
public class MySQLWrapper {
     ...
     * <p>
     * This will return an updated value every 5 minutes. Calling it every minute isn't smart, as
     * it will only update every 5 minutes.
     *
