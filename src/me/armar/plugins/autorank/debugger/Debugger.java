 ...
 * Whenever a player uses the /ar debug command, it will create a new file with all sorts of
 * information. <br>
 * This information can be sent to the author so that he can easily see what's wrong.
 * <p>
