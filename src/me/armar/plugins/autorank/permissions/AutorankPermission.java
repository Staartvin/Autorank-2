...
public final class AutorankPermission {
    ...
    public static final String VIEW_ACTIVITY_OTHERS = "autorank.activity.view.others";
    public static final String VIEW_ACTIVITY_SELF = "autorank.activity.view.self";
