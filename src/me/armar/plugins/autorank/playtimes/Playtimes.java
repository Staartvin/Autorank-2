...
public class Playtimes implements Runnable{
    ...
    public void modifyTime(String name, int timeDifference) throws IllegalArgumentException{
	...
	String statement = "SELECT * FROM " + table +
		" WHERE name='" + syncingName + "'"; 
	ResultSet rs = sql.executeQuery(statement);
	if(rs != null){

	    try {
		if(rs.getDate("modified") == null || rs.getDate("modified").before(Calendar.getInstance().getTime())){
	...
	String statement = "INSERT INTO " + table
		+ " VALUES ('" + syncingName + "', " + syncingTime + ", CURRENT_TIMESTAMP) "
