...
public class Playtimes {
    ...
    /**
     * Use this method to convert an old data.yml (that was storing player names) to the new format
     * (storing UUIDs).
     *
     */
    ...
    /**
     * Returns playtime on this particular server It reads from the local data.yml
     *
