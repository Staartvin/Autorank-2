...
public class TimeWeeklyRequirement extends AbstractRequirement {
    ...
    public String getDescription() {
        return Lang.TIME_WEEKLY_REQUIREMENT.getConfigValue(AutorankTools.timeToString(timeNeeded, TimeUnit.MINUTES));
    }
    ...
    public String getProgressString(UUID uuid) {
        ...
        try {
            playtime = (getAutorank().getPlayTimeManager().getPlayTime(TimeType.WEEKLY_TIME, uuid).get());
