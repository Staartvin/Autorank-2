...
public interface StatsPlugin {
     ...
     * @param arguments Provide arguments for the stat (worldName). 1st argument has to be the
     * world (can be null)
     * @return value of the stat; -1 when the current stats plugin doesn't support this stat; -2 if
     * stat name is invalid
     */
