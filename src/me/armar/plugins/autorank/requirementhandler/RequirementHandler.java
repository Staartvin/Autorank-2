...
/**
 * RequirementHandler will keep track of the latest known group and progress a player made (via /ar
 * complete) When the last known group is not equal to the current group of a player, all progress
 * should be reset as a player is not longer in the same group.
 *
