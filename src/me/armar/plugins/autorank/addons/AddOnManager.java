...
public class AddOnManager {
	...
	/**
	 * AddOnManager handlers all actions between addons and Autorank. You can access this AddOnManager on any time you like.
	...
	/**
	 * Unload an addon so its reference is removed and can no longer be accessed. <br>
	 * <b>NOTE:</b> Autorank will not unload the addon itself. It will only remove the reference to it.
	 * @param addonName
	 */
	...
	public JavaPlugin getLoadedAddon(String addonName) {
		if (!isAddonLoaded(addonName)) return null;
