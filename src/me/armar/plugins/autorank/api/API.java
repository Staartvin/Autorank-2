 ...
 * <p>
 * You, as a developer, can you use this class to get data from players or data about groups. The
 * API is never finished and if you want to see something added, tell us!
 * <p>
 *
 * @author Staartvin
 *
...
public class API {
    ...
    /**
     * Gets all requirements for a player at the exact moment. This does not consider already
     * finished requirement but just mirrors the config file.
     *
    ...
    /**
     * Gets the global play time (playtime across all servers with the same MySQL database linked)
     * of a player.
     * <p>
     *
    ...
    /**
     * Gets the local play time of this player on this server according to Autorank. <br>
     ...
     * requirements.
     * <p>
     * <b>NOTE:</b> This does not mean the player will always be ranked up to this group. If a
     * requirement has its own <i>'rank change'</i> result, the player will be ranked up to that
     * group and not the 'global results' group.
     *
    ...
    /**
     * Register a requirement that can be used in the advanced config. The name should be unique as
     * that is the way Autorank will identify the requirement.
     * <p>
    ...
    /**
     * Register a result that can be used in the advanced config. The name should be unique as that
     * is the way Autorank will identify the result.
     * <p>
     * The name will be the name that is used in the config.
     *
