...
/**
 * This event is called when a player meets the requirement for a group and certain results will be
 * performed.
 *
 * @author Staartvin
 *
...
public class RequirementCompleteEvent extends Event implements Cancellable {
    ...
    /**
     * Create a new RequirementCompleteEvent. This event represents a requirement that is completed
     * by a player.
     *
